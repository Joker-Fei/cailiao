...
public class Accreditation {
	// servlet层
	public Accreditation(int id, String title, String content, int userId,
	...
	// servlet层
	public Accreditation(String title, String content, int userId, int typeId,
	...
	// 多条件信息查询
	public Accreditation(String title, String content, String author, int typeId) {
		super();
		this.title = title;
		this.content = content;
		this.author = author;
