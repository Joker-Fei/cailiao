...
<c:forEach items="${requestScope.workDetailList }"  var="workDetail" varStatus="status">  
 ...
 <tbody><tr>
  ...
  <p></p><h3><o:p>&nbsp;&nbsp;&nbsp;</o:p><a href="workdetailservlet?op=toWorkDetail&id=${workDetail.id }" class="title" style="color: #256eb1"> ${workDetail.title }</a></h3><p></p>
  </td>
  <td style="width:20.0%;" width="20%">
  <p style="text-align:right;padding:0 5.4px 0 0" align="right">发布日期：${workDetail.publishTime }</p>
  </td>
 </tr>
</tbody></table>
...
<li><span class="pageinfo">共 <strong>2</strong>页<strong>20</strong>条</span></li> -->
 <li class="first"><a href="newsdetailservlet?op=toNewsType&pageNo=1">&nbsp;首页&nbsp;</a></li>
