...
<div>
	<div> 
<form action="${pageContext.request.contextPath}/servlet/dmAddServlet" method="post" name="form1" onsubmit="return formCheck33();" id="form1">
	
	<table class="right-table" width="70%" height="90%" border="0px" cellpadding="0" align="center" cellspacing="0" >
		
		<tr >
			<td align="center" width="500px"><a>院系/专业名称</a></td>
			<td><input type="text" size="110" name="dmName"></td>
		</tr>
		<tr>
		 <td colspan="2">
				<textarea   rows="8" cols="15" name="dmIntroduce"></textarea>
				<script type="text/javascript">
