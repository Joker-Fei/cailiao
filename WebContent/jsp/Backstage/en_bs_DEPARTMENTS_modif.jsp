...
<div>
	<div> 
<form action="${pageContext.request.contextPath}/servlet/dmModifServlet?id=${id}" method="post" name="form1" onsubmit="return formCheck33();" id="form1">
	
	<table class="right-table" width="70%" height="90%" border="0px" cellpadding="0" align="center" cellspacing="0" >
		
		<tr >
			<td align="center" width="20"><a>院系/专业名称</a></td>
			<td width="80%"><input type="text" name="dmName" size="110" value="${dmName}"></td>
		</tr>
		<tr>
		 <td colspan="2">
				<textarea   rows="8" cols="15" name="dmIntroduce">${dmIntroduce}</textarea>
				<script type="text/javascript">
			    	var editor =CKEDITOR.replace('dmIntroduce', {
						uiColor: '#FFFFFF',
