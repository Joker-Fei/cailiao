...
public class WorkDetail {
	...
	// servlet层
	public WorkDetail(int id, String title, String content, int userId,
	 ...
	 * // 处理学院概况的信息添加
	 * 
	 * public WorkDetail(String title, String content, int userId, int typeId,
	...
	// 多条件信息查询
	public WorkDetail(String title, String content, String author, int typeId) {
		super();
		this.title = title;
		this.content = content;
		this.author = author;
