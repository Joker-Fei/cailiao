...
<!--登录开始-->
    ...
    <div class="reg login">
        ...
        <form action="userTestCenterServlet" method="post" name="form1" id="form1">
        	<input type="hidden" name="op" value="login"/>
            <dl>
                <div style="height:170px; overflow:hidden"></div>
              
   			<dd><span class="title"><a style="font-size:17px;color:#842b00;text-decoration:none;font-weight:bold;">用户名：</a></span><input class="reg_input" name="iptNickName" id="iptNickName" onblur="checkNickName(this.value)" type="text" /></dd>               
              <dd><span class="title"><a style="font-size:17px;color:#842b00;text-decoration:none;font-weight:bold;">密&nbsp&nbsp&nbsp&nbsp码：</a></span><input class="reg_input" onblur="return checkpasswd(this);" id="t_UserPass" name="t_UserPass" type="password"/></dd>
            </dl>
