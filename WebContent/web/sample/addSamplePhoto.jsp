...
<div class="position">　<a style="font-size:14px;text-decoration:none;color:#FFAA33;" >当前位置：示例照片管理　&gt;&gt;　添加信息　</a>
<div class="div3">
<div class="tableMain">
<div class="div1"> 
<form action="samplePhotoServlet?op=add" method="post" name="form1" onsubmit="return formCheck33();" id="form1">
	...
	<table class="right-table" width="70%" height="90%" border="0px" cellpadding="0" align="center" cellspacing="0" >
			...
			<td>
				<select name="typeId">
					<c:forEach items="${requestScope.photoTypeList }" var="photoType">
						<option value="${photoType.id }">${photoType.typeName }</option>	
					</c:forEach>
				</select>
			</td>
		</tr>
		...
		<tr>
			<td>状态</td>
			<td>
				<%-- <input type="radio" name="pass" value="1" />未通过 --%>
				<input type="radio" name="pass" value="0" checked="checked"/>通过
			</td>
			<td></td>
		</tr>
