...
<div class="position">　<a style="font-size:14px;text-decoration:none;color:#FFAA33;" >当前位置：中心概况管理　&gt;&gt;　添加信息　</a>
<div class="div3">
<div class="tableMain">
<div class="div1"> 
<form action="testCenterInfoServlet?op=add" method="post" name="form1" onsubmit="return formCheck33();" id="form1">
			...
			<td>
				<select name="typeId">
					<c:forEach items="${requestScope.testCenterTypeList }" var="teCTL">
						<option value="${teCTL.id }">${teCTL.typeName }</option>	
					</c:forEach>
				</select>
			</td>
		</tr>
