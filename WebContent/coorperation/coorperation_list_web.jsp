...
<div class="w960 center clear mt1">
 <div class="pright">
  <div class="place"> <strong>当前位置:</strong> <a href="./toFirstWeb.jsp">主页</a>  &gt; <a href="./coorperationdetailservlet?op=toCoorperationType&id=1">科研与合作</a>  &gt;<a>${requestScope.type.typeName }</a></div>
  <!-- /place -->
  <div class="listbox">
   <ul class="e2T">

<c:forEach items="${requestScope.coorperationDetailByType }"  var="coorperationDetail" varStatus="status">  
   <c:if test="${coorperationDetail.pass eq 0}"><!-- 判断新闻是否通过审核 -->
   <li>  
    <table class="MsoTableClassic1" border="0" cellpadding="0" cellspacing="0" width="100%">
 <tbody><tr>
  <td style="width:80.0%;" width="80%">
  <p></p><h3><o:p>&nbsp;&nbsp;&nbsp;</o:p><a href="coorperationdetailservlet?op=toCoorperationDetail&id=${coorperationDetail.id }" class="title" style="color: #256eb1"> ${coorperationDetail.title }</a></h3><p></p>
  </td>
  <td style="width:20.0%;" width="20%">
  <p style="text-align:right;padding:0 5.4px 0 0" align="right">发布日期：${coorperationDetail.publishTime }</p>
  </td>
 </tr>
</tbody></table>
    
<div id="divcss5">
<p1>${coorperationDetail.content }</p1>
</div>
    </li>
    </c:if>
    </c:forEach>                    
...
<li><span class="pageinfo">共 <strong>2</strong>页<strong>20</strong>条</span></li> -->
 <li class="first"><a href="coorperationdetailservlet?op=toCoorperationType&id=${requestScope.type.id }&pageNo=1">&nbsp;首页&nbsp;</a></li>
...
<li class="upPage"><a href="coorperationdetailservlet?op=toCoorperationType&id=${requestScope.type.id }&pageNo=${sessionScope.pageBean.prePage}">&nbsp;上一页&nbsp;</a></li>
<li class="nextPage"><a href="coorperationdetailservlet?op=toCoorperationType&id=${requestScope.type.id }&pageNo=${requestScope.pageBean.nextPage }">&nbsp;下一页&nbsp;</a></li>
			 <li class="lastPage"><a href="coorperationdetailservlet?op=toCoorperationType&id=${requestScope.type.id }&pageNo=${requestScope.pageBean.pageCount }">&nbsp;末页&nbsp;</a></li>
   </ul>
  </div>
  <!-- /pages -->
 </div>
