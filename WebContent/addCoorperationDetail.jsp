...
<div class="position">　<a style="font-size:14px;text-decoration:none;color:#FFAA33;" >当前位置：科研与合作　&gt;&gt;　添加信息　</a>
<div class="div3">
<div class="tableMain">
<div class="div1"> 
<form action="coorperationdetailservlet?op=add" method="post" name="form1" onsubmit="return formCheck33();" id="form1">
			...
			<td>
				<select name="typeId">
					<c:forEach items="${requestScope.coorperationTypeList }" var="coorperationType">
						<option value="${coorperationType.id }">${coorperationType.typeName }</option>	
					</c:forEach>
				</select>
			</td>
		</tr>
