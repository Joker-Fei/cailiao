...
<html>
  <head>
    ...
    <title>My JSP 'en_bs_CUNTACTUS.jsp' starting page</title>
...
function formCheck33()
  ...
  <body>
    <div>
	<div> 
	<form action="${pageContext.request.contextPath}/servlet/modifCuntactus?id=001" method="post" name="form1" onsubmit="return formCheck33();" id="form1">
	<table class="right-table" width="70%" height="90%" border="0px" cellpadding="0" align="center" cellspacing="0" >
		<tr >
			<td colspan="2" align="center" ><a>modif Cuntact us</a></td>
		</tr>
		<tr>
		 <td colspan="2">
				<textarea   rows="8" cols="15" name="Contactus">${Contactus}</textarea>
				<script type="text/javascript">
			    	var editor =CKEDITOR.replace('Contactus', {
						uiColor: '#FFFFFF',
