...
<div class="position">　<a style="font-size:14px;text-decoration:none;color:#FFAA33;" >当前位置：服务指南管理　&gt;&gt;　添加信息　</a>
<div class="div3">
<div class="tableMain">
<div class="div1"> 
<form action="serviceGuideServlet?op=add" method="post" name="form1" onsubmit="return formCheck33();" id="form1">
			...
			<td>
				<select name="typeId">
					<c:forEach items="${requestScope.serviceTypeList }" var="serviceType">
						<option value="${serviceType.id }">${serviceType.typeName }</option>	
					</c:forEach>
				</select>
			</td>
		</tr>
