...
<div class="w960 center clear mt1">
 <div class="pright">
  ...
  <!-- /picnews -->
	...
	<dl class="tbox">
        <dt><strong><a href="accreditationServlet?op=toAccreditationType&typeId=${requestScope.type.id }">${requestScope.type.typeName}</a></strong><!-- <span class="more"><a href="">点此查看更多...</a></span> --> </dt>
        <dd>
          <ul class="e2T">
     <c:forEach items="${requestScope.accreditationList}"  var="accreditationList" varStatus="status">
     <c:if test="${accreditationList.pass==0}">  
          <li>
<table class=MsoTableClassic1 border=0 cellspacing=0 cellpadding=0 width="100%">
 <tr >
  <td width="80%" style='width:80.0%;'>
<h3><o:p>&nbsp;&nbsp;</o:p><a href="accreditationServlet?op=toAccreditationDetail&id=${accreditationList.id}&typeId=${requestScope.type.id }" class="title">&nbsp;${accreditationList.title}</a><br></h3>
</td>
...
<!-- /listbox -->
  <div class="dede_pages">
				<ul class="pagelist">
					<li class="first"><a
						href="accreditationServlet?op=toAccreditationType&typeId=${requestScope.type.id }&pageNo=1">&nbsp;首页&nbsp;</a></li>
					<li class="upPage"><a
						href="accreditationServlet?op=toAccreditationType&typeId=${requestScope.type.id }&pageNo=${requestScope.pageBean.prePage }">&nbsp;上一页&nbsp;</a></li>
					<li class="nextPage"><a
						href="accreditationServlet?op=toAccreditationType&typeId=${requestScope.type.id }&pageNo=${requestScope.pageBean.nextPage }">&nbsp;下一页&nbsp;</a></li>
					<li class="lastPage"><a
						href="accreditationServlet?op=toAccreditationType&typeId=${requestScope.type.id }&pageNo=${requestScope.pageBean.pageCount }">&nbsp;末页&nbsp;</a></li>
...
<!--纵向导航-->
  <div>
   <dl class=" tboxmenu">
    <dt><strong>计量认证</strong></dt>
    <dd>
     <ul class="tboxd6">
	 
     <c:forEach items="${requestScope.accreditationTypeList }" var="nn">                             	
			<li>	
				<a href="accreditationServlet?op=toAccreditationType&typeId=${nn.id }"> ${nn.typeName} </a>
        	 </li>
     </c:forEach> 
...
<div class="footer w960 center mt1 clear">
	...
	<div class="copyright">
	<font face="Times New Roman">版权所有: 哈尔滨理工大学-材料分析测试中心
<!-- /powered --></font>
   </div>
