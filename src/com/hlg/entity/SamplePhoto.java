...
public class SamplePhoto {
	// servlet层
	public SamplePhoto(int id, String title, String content, int userId,
	...
	// servlet层
	public SamplePhoto(String title, String content, int userId, int typeId,
	...
	// 多条件信息查询
	public SamplePhoto(String title, String content, String author, int typeId) {
		super();
		this.title = title;
		this.content = content;
		this.author = author;
