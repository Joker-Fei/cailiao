...
<div class="w960 center clear mt1">
 <div class="pright">
  ...
  <!-- /picnews -->
	...
	<dl class="tbox">
        <dt><strong><a href="testCenterInfoServlet?op=toCenterSurveyType&typeId=${requestScope.type.id }">${requestScope.type.typeName}</a></strong><!-- <span class="more"><a href="">点此查看更多...</a></span> --> </dt>
        <dd>
          <ul class="e2T">
   <c:forEach items="${requestScope.testCenterInfoList}"  var="testCenterInfoList" varStatus="status">         
       <c:if test="${testCenterInfoList.pass == '0'}">
          <li>
 <table class=MsoTableClassic1 border=0 cellspacing=0 cellpadding=0 width="100%">
 <tr >
  <td width="80%" style='width:80.0%;'>
  <%-- <a href="subjectdetailservlet?op=toSubjectDetail&id=${testCenterInfoList.id}" class="preview"><img src="images/xiaohui.png"></a> --%>
<p ><h3><o:p>&nbsp;&nbsp;</o:p><a href="testCenterInfoServlet?op=toCenterSurveyDetail&id=${testCenterInfoList.id}&typeId=${requestScope.type.id }" class="title">&nbsp;${testCenterInfoList.title}</a><br></h3></p>
</td>
...
<!-- /listbox -->
  <div class="dede_pages">
				<ul class="pagelist">
					...
					--%>
					<li class="first"><a
						href="testCenterInfoServlet?op=toCenterSurveyType&typeId=${requestScope.type.id }&pageNo=1">&nbsp;首页&nbsp;</a></li>
					<li class="upPage"><a
						href="testCenterInfoServlet?op=toCenterSurveyType&typeId=${requestScope.type.id }&pageNo=${requestScope.pageBean.prePage }">&nbsp;上一页&nbsp;</a></li>
					<li class="nextPage"><a
						href="testCenterInfoServlet?op=toCenterSurveyType&typeId=${requestScope.type.id }&pageNo=${requestScope.pageBean.nextPage }">&nbsp;下一页&nbsp;</a></li>
					<li class="lastPage"><a
						href="testCenterInfoServlet?op=toCenterSurveyType&typeId=${requestScope.type.id }&pageNo=${requestScope.pageBean.pageCount }">&nbsp;末页&nbsp;</a></li>
...
<!--纵向导航-->
  <div>
   <dl class=" tboxmenu">
    <dt><strong>中心概况</strong></dt>
    <dd>
     <ul class="tboxd6">
	 
     <c:forEach items="${requestScope.testCenterTypeList }" var="nn">                             	
			<li>	
				<a href="testCenterInfoServlet?op=toCenterSurveyType&typeId=${nn.id }"> ${nn.typeName} </a>
        	 </li>
     </c:forEach> 
