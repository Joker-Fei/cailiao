...
public class intrDelServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public intrDelServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		intrService.deleteIntr(request.getParameter("id"));
		String message =String.format(
				"删除成功！<meta http-equiv='refresh' content='1;url=%s'", 
