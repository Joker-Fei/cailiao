...
<!-- /place -->
	<div class="viewbox">
		<div class="title"><h2><a style="color:#227700;text-decoration:none;">${requestScope.coorperationDetail.title }</a></h2></div>
<!-- /title -->
  <div class="info"> <small>发布时间${requestScope.coorperationDetail.publishTime }</small><!----><small>来源:</small>材料科学与工程学院<small>作者:</small>   ${requestScope.coorperationDetail.author }   <script src="introduce_files/count.htm" type="text/javascript" language="javascript"></script></div>
  <!-- /info -->
<!--  -->
		<div class="content">
		<table width="100%">
...
${requestScope.coorperationDetail.content }
</p>
