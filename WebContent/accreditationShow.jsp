...
<!-- /place -->
	<div class="viewbox">
		<div class="title">
		<c:forEach items="${requestScope.accreditationDetail}"  var="accreditationDetail" >  
		<h2><a style="color:#227700;text-decoration:none;">${accreditationDetail.title}</a></h2>
		</c:forEach>
		</div>
<!-- /title -->
  <div class="info"> 
 <c:forEach items="${requestScope.accreditationDetail}"  var="accreditationDetail" >  
  <small>发布时间${accreditationDetail.publishTime }</small><!----><small>来源:</small>材料科学与工程学院<small>作者:</small><!-- --> ${accreditationDetail.author }<script src="introduce_files/count.htm" type="text/javascript" language="javascript"></script>
  </c:forEach>
  </div>
  <!-- /info -->
<!--  -->
