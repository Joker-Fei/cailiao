...
public class intrModifServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public intrModifServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		intr.setId(request.getParameter("id"));
		intr.setIntdIntroduce(request.getParameter("intrIntroduce"));
		intrService.modifIntr(intr);
