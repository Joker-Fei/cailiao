...
<div class="pright">
	<div class="place"><strong>当前位置:</strong> <a href="./toFirstWeb.jsp">主页</a> &gt; <a href="./coorperationdetailservlet?op=toCoorperationType&id=1">科研与合作</a></div>
<!-- /place -->
		<%-- <div class="title"><h2><a style="color:#227700;text-decoration:none;"> ${requestScope.topNewsDetail.title } </a></h2></div> --%>
  <div class="div1"><h2><a style="color:#227700;text-decoration:none;">${requestScope.topNewsDetail.title }</a></h2></div>
	<div class="viewbox">
<!-- /title -->
  <div class="info"> 
  <small>发布时间${requestScope.topNewsDetail.publishTime }</small><!----><small>来源:</small>材料科学与工程学院<small>作者:</small> ${requestScope.topNewsDetail.author } <script src="introduce_files/count.htm" type="text/javascript" language="javascript"></script></div>
  <!-- /info -->
<!--  -->
		<div class="content">
  <img src="./${requestScope.topNewsDetail.imgUrl}"  width="100%" height="100%" border="0"> 
		<table width="100%">
		<tbody><tr>
		<td>
		<style type="text/css">
...
${requestScope.topNewsDetail.content }
</p>
...
<!--纵向导航-->
  ...
  <div class="hot mt1 light">
   <dl class="tbox">
    <dt class="light"><strong>友情链接</strong></dt>
    <dd class="light">
     <ul class="c1 ico2">
      <li><a href="http://www.hrbust.edu.cn/">哈尔滨理工大学</a></li>
<li><a href="http://www.hit.edu.cn/">哈尔滨工业大学</a></li>
<li><a href="http://www.hrbinfo.gov.cn/">哈尔滨市科技局</a></li> 
     </ul>
    </dd>
   </dl>
  </div>
...
<div class="footer w960 center mt1 clear">
	...
	<div class="copyright">
	<font face="Times New Roman">COPYRIGHT2016 , 哈尔滨理工大学材料科学与工程学院 </font>
<!-- /powered -->
   </div>
