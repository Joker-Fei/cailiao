...
<div class="position">　<a style="font-size:14px;text-decoration:none;color:#FFAA33;" >当前位置：学院概况　&gt;&gt;　添加信息　</a>
<div class="div3">
<div class="tableMain">
<div class="div1"> 
<form action="newsdetailservlet?op=add" method="post" name="form1" onsubmit="return formCheck33();" id="form1">
	...
	<table class="right-table" width="70%" height="90%" border="0px" cellpadding="0" align="center" cellspacing="0" >
		...
		<tr >
			<td><a>标题</a></td>
			<td><input   onFocus="if(value==defaultValue){value='';this.style.color='#000'}" onBlur="if(!value){value=defaultValue;this.style.color='#999'}" maxlength="25" style="color:#999999;width:300px;height:25px" type="text" name="title"/><b>请控制在25个字以内</b></td>
		</tr>
		<tr>
			<td><a>发布者</a></td>
	    ...
	    <tr>
			<td>审核状态</td>
			<td>
			<%-- <c:if test="${requestScope.newsTypeList.pass eq 1}"><a>未通过<c:if>  --%>
