...
public class TestCenterInfo {
	// servlet层
	public TestCenterInfo(int id, String title, String content, int userId,
	...
	// servlet层
	public TestCenterInfo(String title, String content, int userId, int typeId,
	...
	// 多条件信息查询
	public TestCenterInfo(String title, String content, String author, int typeId) {
		super();
		this.title = title;
		this.content = content;
		this.author = author;
