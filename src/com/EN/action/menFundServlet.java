...
public class menFundServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public menFundServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String name = request.getParameter("menName");
		
		menbersService menService = new menbersService();
		List<menbers> lsmen = new ArrayList<menbers>();
		if(menService.fundname(name)!=null){
			lsmen.add(menService.fundname(name));
		}else{
			request.getSession().setAttribute("Msg","查无此人！请输入准备信息！");
			lsmen=menService.fundAll();
		}
