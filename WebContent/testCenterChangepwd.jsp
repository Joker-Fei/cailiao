...
function validateLoginname() {
	 ...
	 */
	$.ajax( {
		url : "userTestCenterServlet",//第一步 ，要请求的servlet
		data : {
			pwd : value,
			op : checkPwd,
			id : id
...
<form name="myform" action="userTestCenterServlet?op=changePwd" method="post" >
<input type="hidden" name="id" value="${sessionScope.loginUser_testCenter.id} " id="id">
